...
class InvalidVerificationCodeAlert implements AlertDialogContent {
  ...
  @override
  final String textForUser =
      'Пароль не предоставлен или не соответствует паролю, привязанному к аккаунту.';
...
class OperationNotAllowedAlert implements AlertDialogContent {
  ...
  @override
  final String textForUser =
      'Клиент-приложение не согласовано с сервером. Сообщите об ошибке и ожидайте обновления.';
...
class UserNotFoundAlert implements AlertDialogContent {
  ...
  @override
  final String textForUser =
      '''Не найден аккаунт, привязанный к данным реквизитам. Возможные причины:
...
class WrongPasswordAlert implements AlertDialogContent {
  ...
  @override
  final String textForUser =
      'Пароль неправильный или регистрация проводилась методами не требущими пароля.';
